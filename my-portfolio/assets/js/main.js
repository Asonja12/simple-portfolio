...
const sendEmail = (e) => {
    ...
    emailjs
        ...
        .then(
            () => {
                // Show sent message
                contactMessage.textContent = "Message sent to Asonja successfully ✅";
            ...
            () => {
                // Show error msg
                contactMessage.textContent =
                    "Oops! Asonja did not recieve your message (service error) ❌";
            }
        );
};
...
// Select all the sections you want to track
